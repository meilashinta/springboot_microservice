...
public class PengembalianController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Pengembalian> updatePengembalian(@PathVariable Long id,
            @RequestBody Pengembalian pengembalian) throws ParseException {
        Pengembalian pengembalianUpdate = pengembalianService.updatePengembalian(id, pengembalian);
        return pengembalianUpdate != null ? ResponseEntity.ok(pengembalianUpdate) : ResponseEntity.notFound().build();
    }
